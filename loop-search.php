<div id="all-search">
<div id="main-index-search">

<div id="main-index-search-box">
<form name="chbox" action="<?php echo home_url( '/' ); ?>" method="get">

<ul class="main-index-search-button">
<div class="main-index-search-button-red-l"><label for="a01"><input type="checkbox" value="otamesisinsa" id="a01">
...
<div class="main-index-search-button-red-r"><label for="a08"><input type="checkbox" value="sokujituyuusi" id="a08">
<span class="main-index-search-text-r">今すぐ借りたい！即日融資</span></label></div>
<div class="main-index-search-button-red-l"><label for="b01"><input type="checkbox" value="sokujitusinsa" id="b01">
<span class="main-index-search-text-r">即日で審査結果がわかる</span></label></div>
<div class="main-index-search-button-red-r"><label for="a04"><input type="checkbox" value="raitenhuyou" id="a04">
<span class="main-index-search-text-r">来店不要でカード発行OK</span></label></div>
<div class="main-index-search-button-white-l"><label for="a10"><input type="checkbox" value="souryoukiseigai" id="a10">
<span class="main-index-search-text-w">総量規制対象外</span></label></div>

<div class="main-index-search-button-white-r"><label for="a06"><input type="checkbox" value="hosyounin" id="a06">
<span class="main-index-search-text-w">収入証明書が不要</span></label></div>
<!--<li><label for="a07"><input type="checkbox" value="jidousina" id="a07">自動審査</label></li>-->
</ul>
...
</div><!-- #main-search-index-box -->

</div><!-- #main-search-index -->
</div><!-- #all-search -->