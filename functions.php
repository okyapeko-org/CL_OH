...
<dl <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
<dt class="main-item-kuchi-name"><?php comment_text() ?></dt>
<dd class="main-item-kuchi-text"><?php comment_author(); ?>さん <span class="main-item-toukou">投稿日時: <?php printf(__('%1$s at %2$s'), get_comment_date(),  get_comment_time()) ?></span></dd>
</dl>
...
function my_bread(){
     ...
     //カテゴリアーカイブ
        ...
        single_cat_title();
     //個別記事ページ
     }elseif(is_single(array('21','43','37','10','41','52','37','50','45','54'))){
	    echo '<a href="'. get_bloginfo('url').'">HOME</a>';
		echo SEPA;
        while(have_posts()){
        	the_post();
            ...
            $cat = $cat[0];
            //【表示】カテゴリ
		echo '<a href="<?php echo home_url( '/' ); ?>search">キャッシング検索</a>&nbsp;&gt;&nbsp;';
            //【表示】記事タイトル
            the_title();
        }
